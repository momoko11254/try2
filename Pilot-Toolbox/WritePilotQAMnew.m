...
P.skewY1  = (1.6+XYSkew)*1e-12;             % +/- Relative phase (time delay) difference btw Ch3 versus Ch4 )
...
Sig.Fb = SP.Fb;                             % Symbol rate (Baud rate)
P.RandData = 1;
...
P.Rolloff = SP.RollOff;                     % Rolloff factor
P.Ast = SP.RRCType;                         % Stop Band attenuation
...
SignalOut.Fb = Sig.Fb;
SignalOut.Et(1,:) = IFilx+1i*QFilx;
SignalOut.Et(2,:) = IFily+1i*QFily;
SignalOut.Fs = Sig.Fs;
