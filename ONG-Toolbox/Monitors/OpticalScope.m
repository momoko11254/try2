function OpticalScope(varargin)
% Optical Oscilloscope. User selectable vertical scale Power in dBm or
% Watts. Accepts an arbitrary number of optical signals. displays the
% optical intensity, phase and chirp.
%
% TeraScope(varargin,yScale)
%
