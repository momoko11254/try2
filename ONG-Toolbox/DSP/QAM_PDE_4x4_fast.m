function [SignalOut, varargout] = QAM_PDE_4x4_fast(SignalIn, P)
% Blind Equaliser using the Radially Directed Algorithm for updated and
% minimising least mean square. Uses 4x4 real structure. It is also
% interleaved with the Decision Directed Phase Estimator. Updated on symbol
% based. Can be used with all M-QAM.
% 
% [SignalOut, varargout] = QAM_PDE_4x4_fast(SignalIn, P)
%
% Inputs:
...
[out1,out2,out3,out4,error1,error2,H11,H12,H13,H14,H21,H22,H23,H24,H31,H32,H33,H34,H41,H42,H43,H44,phase1,phase2] ...
    = pde_qam_4x4_mex(fout2n1,fout2n2,fout2n3,fout2n4,H11,H12,H13,H14,...
    H21,H22,H23,H24,H31,H32,H33,H34,H41,H42,H43,H44,points,cpewindow,mu);

%% Apply phase estimate
SignalOut.Et(1,:) = (out1+1j*out2).*exp(-1j*phase1);
SignalOut.Et(2,:) = (out3+1j*out4).*exp(-1j*phase2);
