function [SignalOut, varargout] = QAM_RDE_4x4_fast(SignalIn, P)
...
% 
% Source: "Blind Equalization of Receiver In-Phase/Quadrature Skew in the
% Presence of Nyquist Filtering" Paskov PTL December 2013.
% 
% [SignalOut, varargout] = QAM_RDE_4x4_fast(SignalIn, P)
%
% Inputs:
...
for index = 1:length(P.mu)
    ...
    [out1,out2,out3,out4,P.ErrorX,P.ErrorY] ...
            = rde_qam_4x4_mex(fout2n1,fout2n2,fout2n3,fout2n4,H11,H12,H13,H14,...
            H21,H22,H23,H24,H31,H32,H33,H34,H41,H42,H43,H44,radii,mu);
end
