...
% Modified: Heribert Brust, December 2005
% Modified: David Millar, May 2008:
% Modified: Sean Kilmurray, November 2013:
...
if(isfield(P, 'verbose') && (P.verbose>=2))
    disp(' ');
    disp('Adding Optical Noise');
    disp(['OSNR: ' num2str(P.OSNR) 'dB']);
end
end